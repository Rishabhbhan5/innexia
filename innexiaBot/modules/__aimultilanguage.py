...
async def hmm(_, message):
    ...
    if status == "ON" or status == "on" or status == "On":
        ...
        if not lol:
            await lel.edit("jennie AI Already Activated In This Chat")
            return
        await lel.edit(
            f"jennie AI Successfully Added For Users In The Chat {message.chat.id}"
        )
        ...
        if not Escobar:
            await lel.edit("jennie AI Was Not Activated In This Chat")
            return
        await lel.edit(
            f"jennie AI Successfully Deactivated For Users In The Chat {message.chat.id}"
        )
